    ...
    public class StyleShopDbContext : IdentityDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>()
                .HasData
                (
                    new Product() { Id = 1, Name = "Iphone 13", Description = "The iPhone 13, introduced in 2021, is part of Apple's flagship smartphone series.", Price = 699.99M, Quantity = 100, ProductCategoryId = 1 },
                    new Product() { Id = 2, Name = "Nike sports sweatshirt", Description = "Elevate your athletic wardrobe with the Nike Dri-FIT Performance Crewneck Sweatshirt, a perfect blend of style and functionality.", Price = 24.99M, Quantity = 100, ProductCategoryId = 2 },
                    new Product() { Id = 3, Name = "Game of Thrones - A Clash of Kingdoms", Description = "Dive into the epic realm of Westeros with 'A Clash of Kingdoms,' the latest installment in the gripping 'Game of Thrones' series by George R.R. Martin.", Price = 9.99M, Quantity = 100, ProductCategoryId = 3 }
                );

            modelBuilder.Entity<OrderStatus>()
                .HasData
                (
                    new OrderStatus() { Id = 1, Name = "Preparation" },
            ...
            modelBuilder.Entity<Order>()
                .HasData
                (
                    new Order() { Id = 1, ProductQuantity = 1, OrderStatusId = 1, ProductId = 1, UserId = TESTER_USER_ID, TotalPrice = 699.99M },
                    new Order() { Id = 2, ProductQuantity = 2, OrderStatusId = 2, ProductId = 2, UserId = TESTER_USER_ID, TotalPrice = 49.98M },
                    new Order() { Id = 3, ProductQuantity = 3, OrderStatusId = 3, ProductId = 3, UserId = TESTER_USER_ID, TotalPrice = 29.97M }
                );

            modelBuilder.Entity<Order>()
                .OwnsOne(o => o.OrderAddress)
                .HasData(
                    new { OrderId = 1, Street = "789 Pine Lane", City = "Birmingham", PostalCode = "54321", Country = "UK" },
